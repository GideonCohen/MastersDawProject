...
public class Sample {	
	...
	/**
	 * Custom constructor to take an array of bytes as opposed to an AudioInputStream object
	 *
	 * @param bytes A sound file represented as an array of bytes
	 */
	public Sample(byte[] bytes) throws IOException {

		AudioInputStream a = new AudioInputStream(new ByteArrayInputStream(bytes),
				new AudioFormat(44000, 16, 2, true, false), bytes.length);
